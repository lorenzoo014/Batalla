...
class Escenarios():
    ...
    def __init__(self,x,y,a,b):
        self.__monedas = x
        self.__numero_miermbros_ekip = y
    ...
    def get_miembros_ekip(self):
        return self.__numero_miermbros_ekip
    ...
    def from_str(x):
        ...
        for tp in TipoEscenario:
            if escenario == tp.name:     #explicacion---> la clase enum define por defecto el atributo name el cual te devuelve el nombre de la clave
                a = tp.value            #cuidado con esta sentencia esta bien aplicada porque esta en un escenario concreto gracias a la iteracion
